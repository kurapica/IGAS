...
do
	...
	local _Queue = {}
	local _MaxQueue = 10
	local WorldFrame = IGAS.WorldFrame
	
	local frmColorPicker = ColorPicker("IGAS_GUI_COLORPICKER", WorldFrame)
    ...
    local _DropDownListContainer = Frame("IGAS_GUI_ListContainer", WorldFrame)	
